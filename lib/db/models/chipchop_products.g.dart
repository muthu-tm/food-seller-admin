part of 'chipchop_products.dart';

ChipChopProducts _$ChipChopProductsFromJson(Map<String, dynamic> json) {
  return ChipChopProducts()
...
Map<String, dynamic> _$ChipChopProductsToJson(ChipChopProducts instance) =>
    <String, dynamic>{
      'uuid': instance.uuid,
